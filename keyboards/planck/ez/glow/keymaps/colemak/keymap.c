...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_planck_grid(
    ...
    TD(DANCE_1),    ST_MACRO_0,     KC_LEFT_ALT,    KC_LEFT_CTRL,   OSL(_SYMBOL),   KC_SPACE,       KC_NO,          OSL(_NUMPAD),   KC_LEFT_GUI,    TO(_GAME),      ST_MACRO_1,     KC_ENTER
  ),
  ...
  [_SYMBOL] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          MO(_CONTROL),   KC_TRANSPARENT, TO(_BASE),      KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_NUMPAD] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(_CONTROL),   KC_TRANSPARENT, KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, TO(_BASE),      KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_CONTROL] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,      KC_TRANSPARENT,    KC_TRANSPARENT,      KC_TRANSPARENT, KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, TO(_BASE),      KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_GAME] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,          OSL(_FUNCTION), KC_TRANSPARENT, TO(_BASE),      KC_TRANSPARENT, KC_TRANSPARENT
  ),
  ...
  [_ARROW] = LAYOUT_planck_grid(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, MO(_WINDOW),    KC_TRANSPARENT, KC_NO,          MO(_MOUSE),     KC_TRANSPARENT, TO(_BASE),      KC_TRANSPARENT, KC_TRANSPARENT
  ),
